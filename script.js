...
async function searchCountry(countryName) {
    try {
        ...
        countryInfo.innerHTML = `
            ...
            <img src="${country.flags.svg || country.flags.png}" alt="Flag of ${country.name.common}" width="150">
...
async function fetchBorders(borderCodes) {
    ...
    try {
        ...
        data.forEach(neighbor => {
            ...
            div.innerHTML = `
                <img src="${neighbor.flags.svg || neighbor.flags.png}" alt="Flag of ${neighbor.name.common}" width="50">
